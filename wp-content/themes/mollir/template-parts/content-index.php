			...
			<div class="uk-slider-container">
				<ul class="uk-slider uk-grid-medium uk-grid uk-grid-width-large-1-4 uk-grid-width-medium-1-3 uk-grid-width-small-1-2">
					...
					<li>
						...
						<a href="<?=$gallery[$i]->url?>" style="background-image: url('<?=$gallery[$i]->url?>')" data-uk-lightbox="{group:'slider-group'}">
						</a>
						<?php endif; ?>
						<?php if(isset($gallery[$i+1])): ?>
						<a href="<?=$gallery[$i+1]->url?>" style="background-image: url('<?=$gallery[$i+1]->url?>')" data-uk-lightbox="{group:'slider-group'}">
						</a>
						<?php endif;?>
					</li>
					<?php endfor; ?>
